...
class PhaseType(str, Enum):
    ...
    FOLLOWUP = "followup"  # New work added by followup_planner / review-loop
...
class VerificationType(str, Enum):
    ...
    E2E = "e2e"  # End-to-end test (LLM-emitted; treat similar to browser/manual)
    INTEGRATION = "integration"  # Integration test (LLM-emitted)
    UNIT = "unit"  # Unit test (LLM-emitted)
