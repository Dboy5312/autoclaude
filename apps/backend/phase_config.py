...
MODEL_BETAS_MAP: dict[str, list[str]] = {
    ...
    "opus-4.7-1m": ["context-1m-2025-08-07"],
    "opus-4.8-1m": ["context-1m-2025-08-07"],
}
...
# Note: Opus 4.7 ONLY supports adaptive reasoning (no fixed-budget mode).
# Opus 4.6 and Sonnet 4.6 support both; set CLAUDE_CODE_DISABLE_ADAPTIVE_THINKING=1
# to fall back to fixed-budget mode on those.
