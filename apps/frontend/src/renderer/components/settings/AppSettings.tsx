...
export type AppSection = 'appearance' | 'display' | 'language' | 'devtools' | 'terminal-fonts' | 'agent' | 'personalization' | 'paths' | 'integrations' | 'accounts' | 'api-profiles' | 'updates' | 'notifications' | 'debug';
  ...
  const renderAppSection = () => {
    switch (appSection) {
      ...
      case 'personalization':
        return <PersonalizationSettings settings={settings} onSettingsChange={setSettings} />;
      case 'paths':
