...
export type SidebarView = 'kanban' | 'terminals' | 'roadmap' | 'context' | 'ideation' | 'github-issues' | 'gitlab-issues' | 'github-prs' | 'gitlab-merge-requests' | 'changelog' | 'insights' | 'worktrees' | 'agent-tools' | 'hooks' | 'scheduled' | 'connectors' | 'plugins' | 'skills' | 'buildbay';
...
const baseNavItems: NavItem[] = [
  ...
  { id: 'hooks', labelKey: 'navigation:items.hooks', icon: Webhook, shortcut: 'H' },
  { id: 'scheduled', labelKey: 'navigation:items.scheduled', icon: Clock, shortcut: 'S' },
  { id: 'connectors', labelKey: 'navigation:items.connectors', icon: Plug, shortcut: 'X' },
  { id: 'plugins', labelKey: 'navigation:items.plugins', icon: Boxes, shortcut: 'U' },
  { id: 'skills', labelKey: 'navigation:items.skills', icon: Wand2, shortcut: 'E' },
  { id: 'buildbay', labelKey: 'navigation:items.buildbay', icon: HardHat, shortcut: 'V' },
