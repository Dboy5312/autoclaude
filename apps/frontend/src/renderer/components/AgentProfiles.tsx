import { Brain, Scale, Zap, Check, Sparkles, Flame } from 'lucide-react';
...
export function AgentProfiles() {
  ...
  const handleSelectProfile = async (profileId: string) => {
    ...
    // Apply the profile in full: clear any custom phase overrides so the profile's
    // phase config wins, and if the profile carries feature/default-model overrides
    // (e.g. OVERCOMPLICATED) push those through too so every AI surface uses the
