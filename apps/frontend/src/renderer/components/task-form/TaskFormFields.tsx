...
interface TaskFormFieldsProps {
  ...
  // Generic file attachments (PDFs, text, code, configs, etc.)
  ...
  return (
    <>
      ...
      <div className="space-y-6">
        ...
        {/* Attached Files (PDFs, text, code, configs) — sits beside Reference Images. */}
        <div className="space-y-2 p-4 rounded-lg border border-border bg-muted/30">
          <div className="flex items-center justify-between">
            ...
            <span className="text-xs text-muted-foreground">PDF, text, code, configs</span>
          </div>
