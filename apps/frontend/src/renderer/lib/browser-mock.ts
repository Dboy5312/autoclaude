...
const browserMockAPI: ElectronAPI = {
  ...
  cron: {
    ...
    update: async () => ({ success: false, error: 'Not available in browser mode' }),
    remove: async () => ({ success: true, data: { removed: false } }),
    toggle: async () => ({ success: false, error: 'Not available in browser mode' }),
    fireNow: async () => ({ success: false, error: 'Not available in browser mode' }),
    validate: async () => ({ success: false, error: 'Not available in browser mode' }),
    onChanged: () => () => {},
    onFired: () => () => {},
  },
  ...
  plugins: {
    list: async () => ({ success: true, data: [] }),
    reload: async () => ({ success: true, data: [] }),
    toggle: async () => ({ success: false, error: 'Not available in browser mode' }),
    installToProject: async () => ({ success: true, data: { servers: [] } }),
    openFolder: async () => ({ success: false, error: 'Not available in browser mode' }),
    onChanged: () => () => {},
  },
  ...
  skills: {
    ...
    toggle: async () => ({ success: false, error: 'Not available in browser mode' }),
    openFolder: async () => ({ success: false, error: 'Not available in browser mode' }),
    createFromTemplate: async () => ({ success: false, error: 'Not available in browser mode' }),
    onChanged: () => () => {},
  },
  ...
  persona: {
    get: async () => ({ success: true, data: { content: '' } }),
