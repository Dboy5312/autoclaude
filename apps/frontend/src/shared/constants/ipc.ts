...
// GitLab integration
  ...
  // Preview operations
  PREVIEW_LIST_RENDERABLE: 'preview:listRenderable',

  // Scheduled tasks (cron) — fire-and-forget scheduled task creators
  CRON_LIST: 'cron:list',
  CRON_CREATE: 'cron:create',
  CRON_UPDATE: 'cron:update',
  CRON_DELETE: 'cron:delete',
  CRON_TOGGLE: 'cron:toggle',
  CRON_FIRE_NOW: 'cron:fireNow',
  CRON_VALIDATE_EXPRESSION: 'cron:validateExpression',
  CRON_CHANGED: 'cron:changed',  // event: list mutated (main -> renderer)
  CRON_FIRED: 'cron:fired',      // event: a scheduled task is due (main -> renderer)

  // Plugin loader
  PLUGINS_LIST: 'plugins:list',
  PLUGINS_RELOAD: 'plugins:reload',
  PLUGINS_TOGGLE: 'plugins:toggle',
  PLUGINS_INSTALL_TO_PROJECT: 'plugins:installToProject',
  PLUGINS_OPEN_FOLDER: 'plugins:openFolder',
  PLUGINS_CHANGED: 'plugins:changed',  // event: list changed (main -> renderer)

  // Skills runtime (file-based capability packs)
  SKILLS_LIST: 'skills:list',
  SKILLS_RELOAD: 'skills:reload',
  SKILLS_TOGGLE: 'skills:toggle',
  SKILLS_OPEN_FOLDER: 'skills:openFolder',
  SKILLS_CREATE_FROM_TEMPLATE: 'skills:createFromTemplate',
  SKILLS_CHANGED: 'skills:changed',

  // Output styles (response format presets)
  OUTPUT_STYLES_LIST: 'outputStyles:list',
  OUTPUT_STYLES_RELOAD: 'outputStyles:reload',
  OUTPUT_STYLES_OPEN_FOLDER: 'outputStyles:openFolder',
  OUTPUT_STYLES_CHANGED: 'outputStyles:changed',

  // Persona / SOUL.md (insights chat — output style + persona)
  PERSONA_GET: 'persona:get',
  PERSONA_SAVE: 'persona:save',

  // Global agent instructions — AGENT_INSTRUCTIONS.md, prepended to all
  // pipeline phases (planning/coding/QA). Pipeline-safe.
  AGENT_INSTRUCTIONS_GET: 'agentInstructions:get',
  AGENT_INSTRUCTIONS_SAVE: 'agentInstructions:save',
  ...
  HOOKS_OPEN_FILE: 'hooks:openFile',
  HOOK_FIRED: 'hooks:fired',
  HOOK_TRUST_REQUIRED: 'hooks:trustRequired',
