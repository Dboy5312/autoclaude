...
export interface AgentProfile {
  ...
  // Optional: profile can also override the per-feature model/thinking configuration
  // (insights, ideation, roadmap, githubIssues, githubPrs, utility) and the global
  // defaultModel. When omitted, selecting the profile leaves those settings alone.
  featureModels?: FeatureModelConfig;
  featureThinking?: FeatureThinkingConfig;
  defaultModel?: ModelTypeShort;
...
export interface AppSettings {
  ...
  // Output style id (selected from <userData>/output-styles/*.md)
  selectedOutputStyleId?: string;
  // Active skill ids (loaded from <userData>/skills/*/SKILL.md)
